              ...
              <div className="mb-4">
                ...
                <div className="flex ">
                  <input
                    ...
                    className="w-full p-2 border-gray-200 rounded-l-md focus:ouline-none focus:border-blue-500"
                  />
                  <button
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-4">
                    ...
                    <select className="w-full p-2 border border-gray-200 rounded-md focus:ouline-none focus:border-blue-500">
