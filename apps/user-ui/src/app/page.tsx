...
const page = () => {
  ...
  const { data: latestProducts, isLoading: isLatestLoading } = useQuery<any[]>({
  ...
  const { data: shops, isLoading: isShopLoading } = useQuery<any[]>({
    queryKey: ["shops"],
    queryFn: async () => {
   ...
   const { data: offers, isLoading: isOfferLoading } = useQuery<any[]>({
     queryKey: ["offers"],
     queryFn: async () => {
