    ...
    <div className="w-full min-h-[350px] h-max bg-white rounded-lg relative">
      ...
      <Link href={`/product/${product?.slug}`}>
        <img
          ...
          width={300}
          height={300}
          className="w-full h-[200px] object-cover m-auto rounded-t-md"
        />
      </Link>
      ...
      {isEven && timeLeft && (
        <div className="mt-2">
          <span className="inline-block text-sm bg-orange-100 text-orange-600">
            {timeLeft}
          </span>
        </div>
      )}
